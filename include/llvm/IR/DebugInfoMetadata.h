...
public:
  ...
  /// @{
  void replaceSourceLanguage(unsigned L) { SourceLanguage = L; }
  void replaceFilename(StringRef Filename, StringRef Directory) {
    replaceOperandWith(0, DIFile::get(getContext(), Filename, Directory));
  }
...
public:
  ...
  void replaceVariables(DILocalVariableArray N) { replaceOperandWith(7, N.get()); }

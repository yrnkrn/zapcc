...
Function *CallGraph::removeFunctionFromModule(CallGraphNode *CGN) {
  ...
  // In caching mode we mark the function dead but do not actually
  // delete the inlined function as it may be required later.
  if (M.CachingMode) {
    F->resetAlive();
    // Inline.cpp will delete the return value, C++ allows delete nullptr.
    return nullptr;
  }

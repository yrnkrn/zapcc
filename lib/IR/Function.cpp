...
void Function::invalidateMachineFunction() {
  if (Module *M = getParent())
    if (M->invalidateMachineFunctionHandler)
      M->invalidateMachineFunctionHandler(this);
}

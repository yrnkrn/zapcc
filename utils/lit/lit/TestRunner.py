...
def applySubstitutions(script, substitutions):
    ...
    def processLine(ln):
        ...
        for a,b in substitutions:
            # tools/clang/test/zappc/lit.local.cfg uses pattern replacement with group substitution against first group found "\1"
            # Do not escape it under windows or it will mess up
            if kIsWindows and b!="\\1":
                b = b.replace("\\","\\\\")
            ln = re.sub(a, b, ln)

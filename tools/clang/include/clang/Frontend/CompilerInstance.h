...
public:
  ...
  std::function<void(BackendAction Action, raw_pwrite_stream *)> CachingEmitObj;
  std::function<void(const FileEntry *)> CachingIncludedCallBack;
  llvm::raw_ostream *DiagsOS = nullptr;
  std::function<void(Preprocessor &PP)> PreprocessorCreatedCallBack;

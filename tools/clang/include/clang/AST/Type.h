...
#include "clang/Basic/OpenCLImageTypes.def"
  ...
  void setCanonicalTypeInternal(QualType QT) { CanonicalType = QT; }
...
public:
  ...
  void setDecl(UnresolvedUsingTypenameDecl *D) { Decl = D; }
...
public:
  ...
  void setDecl(TypedefNameDecl *D) { Decl = D; }
...
public:
  ...
  TagDecl *getRawDecl() const { return decl; }
  void setRawDecl(TagDecl *D) { decl = D; }
...
public:
  ...
  void setDecl(TemplateTypeParmDecl *D) {
...
public:
  ...
  TemplateName getTemplateName() const { return Template; }
  TemplateName &getTemplateName() { return Template; }
...
public:
  ...
  CXXRecordDecl *getRawDecl() const { return Decl; }
  void setRawDecl(CXXRecordDecl *D) { Decl = D; }

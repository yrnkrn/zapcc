...
protected:
  Decl(Kind DK, DeclContext *DC, SourceLocation L)
    ...
    if (DK != Kind::ParmVar && DK != Kind::TranslationUnit &&
        DK != Kind::ImplicitParam && DK != Kind::AccessSpec)
      insertNewDecls(this);
  }
...
public:
  bool ignoreGeneratedDecl() const;
  static void insertNewDecls(Decl *D);
  static void insertModifiedDecls(Decl *Dependee, Decl *Dependent);
  ...
  void setNextDeclInContext(Decl *D) { NextInContextAndBits.setPointer(D); }
...
public:
  ...
  Decl *&getFirstDeclDC() const { return FirstDecl; }
  Decl *&getLastDeclDC() const { return LastDecl; }
  ...
  void setLookupPtr(StoredDeclsMap *Ptr) const { LookupPtr = Ptr; }
  bool getHasLazyLocalLexicalLookups() const {
    return HasLazyLocalLexicalLookups;
  }
  void setHasLazyLocalLexicalLookups(bool b) { HasLazyLocalLexicalLookups = b; }

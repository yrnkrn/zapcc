...
public:
  ...
  void setDefinitionData(CXXRecordDecl *D) {
    for (auto I : redecls())
      if (D)
        cast<CXXRecordDecl>(I)->DefinitionData->Definition = D;
      else
        cast<CXXRecordDecl>(I)->DefinitionData = nullptr;
  }
...
public:
  ...
  void setRawNominatedNamespace(NamedDecl *ND) {
...
public:
  ...
  bool eraseShadowDecl(UsingShadowDecl *S);

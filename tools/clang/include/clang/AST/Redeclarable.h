...
protected:
  ...
  public:
    ...
    void setMostRecent(decl_type *D) {
      if (NextIsPrevious()) {
        Next = KnownLatest(D);
      } else {
        setLatest(D);
...
public:
 Redeclarable(const ASTContext &Ctx)
  ...
  void setFirstDecl(decl_type *D) { First = D; }
  ...
  void setPrevious(decl_type *Previous) {
    RedeclLink.setPrevious(Previous);
  }

  void setMostRecent(decl_type *MostRecent) {
    RedeclLink.setMostRecent(MostRecent);
  }

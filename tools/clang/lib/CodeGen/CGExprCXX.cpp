...
static void EmitNullBaseClassInitialization(CodeGenFunction &CGF,
  ...
  if (!NullConstantForBase->isNullValue()) {
    ...
    CGF.CGM.insertDeclGlobalValues(Base, NullVariable);
...
llvm::Value *CodeGenFunction::EmitCXXTypeidExpr(const CXXTypeidExpr *E) {
  ...
  if (E->isTypeOperand()) {
    ...
    CGM.insertFunctionTypeInfos(CurFn, TypeInfo);
  ...
  llvm::Constant *TypeInfo = CGM.GetAddrOfRTTIDescriptor(OperandTy);
  CGM.insertFunctionTypeInfos(CurFn, TypeInfo);

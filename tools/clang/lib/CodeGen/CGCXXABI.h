...
public:
  virtual void eraseUserDecls(
      llvm::SmallPtrSetImpl<const CXXRecordDecl *> &UserCXXRecords) = 0;
  virtual void eraseUserConstants(
      llvm::SetVector<llvm::Constant *> &ConstantsToEraseCompletely) = 0;
